...
{
    app.setStyleSheet("QWidget        { font-family: Arial; background: rgb(255,255,255); }"
                      "QFrame         { border: none; }"
                      "QComboBox      { color: rgb(64,64,64); }"
                      "QComboBox QAbstractItemView::item { color: rgb(64,64,64); }"
                      "QPushButton    { background: rgb(0,204,255); color: rgb(64,64,64); }"
                      "QDoubleSpinBox { background: rgb(255,255,255); color: rgb(64,64,64); border-color: rgb(0,204,255); }"
                      "QLineEdit      { background: rgb(255,255,255); color: rgb(64,64,64); border-color: rgb(0,204,255); }"
                      "QTextEdit      { background: rgb(255,255,255); color: rgb(64,64,64); }"
                      "QPlainTextEdit { background: rgb(255,255,255); color: rgb(64,64,64); }"
                      "QMenuBar       { background: rgb(255,255,255); color: rgb(64,64,64); }"
                      "QMenu          { background: rgb(255,255,255); color: rgb(64,64,64); }"
                      "QMenu::item:selected { background-color: rgb(200,240,255); }"
                      "QLabel         { color: rgb(64,64,64); }"
                      "QScrollBar     { color: rgb(64,64,64); }"
                      "QCheckBox      { color: rgb(0,204,255); }"
                      "QRadioButton   { color: rgb(64,64,64); }"
                      "QTabBar::tab   { color: rgb(64,64,64); border: 1px solid rgb(0,204,255); border-bottom: none; padding: 5px; }"
                      ...
                      "QToolButton    { background: rgb(255, 255, 255); color: rgb(64,64,64); border: none; border-left-color: rgb(0, 0, 0); border-left-style: solid; border-left-width: 6px; margin-top: 8px; margin-bottom: 8px; }"
                      ...
                      "QProgressBar   { color: rgb(64,64,64); border-color: rgb(0,204,255); border-width: 1px; border-style: solid; }"
                      "QProgressBar::chunk { background: rgb(200,240,255); }"
                      "QTreeView::item { background: rgb(200,240,255); color: rgb(64,64,64); }"
                      "QTreeView::item:selected { background-color: rgb(0,204,255); }"
                      "QTableView     { gridline-color: rgb(0,204,255); }"
                      "QHeaderView::section { background: rgb(121,218,255); color: rgb(64,64,64); }"
