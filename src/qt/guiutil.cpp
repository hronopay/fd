...
void SetBlackThemeQSS(QApplication& app)
{
    app.setStyleSheet("QWidget        { background: rgb(255,255,255); }"
                      ...
                      "QPushButton    { background: rgb(85,85,85); color: rgb(221,221,221); }"
                      ...
                      "QTabBar::tab:selected  { background: rgb(111,111,111); }"
                      "QTabBar::tab:!selected { background: rgb(22,22,22); margin-top: 2px; }"
                      ...
                      "QToolButton:checked { color: rgb(255,255,255); border: none; border-left-color: rgb(111,111,111); border-left-style: solid; border-left-width: 6px; }"
