...
void BitcoinGUI::createMenuBar()
{
    ...
    appMenuBar->setStyleSheet("QMenuBar::item {font-family: Arial; font-size: 11pt; color: #808080; border: 1px solid #00c8f8; background-color: rgb(200,240,255);}" + "QMenu::item:hover {background-color: rgb(0, 0, 255);}" + "QPushButton {font-family: Arial; font-size: 11pt; color: #808080; border: 1px solid gray;padding: 1px 18px 1px 3px;min-width: 6em; background-color: rgb(200,240,255);}");
