...
const string strMessageMagic = "Fdel Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight == 1) {
        ...
        nSubsidy = 4000 * COIN; // premine
    }
    else if (nHeight >= 12 && nHeight < 29000) {
        nSubsidy = 0.001 * COIN; 
    }
    else if (nHeight >= 29000 && nHeight < 500000) {
        nSubsidy = 0.0015 * COIN; 
    }
    else if (nHeight >= 500000)     nSubsidy = 0 * COIN;
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if(nBestHeight >=   20       &&  nBestHeight <  1000    ){ nSubsidy =   1    * COIN; }
else if(nBestHeight >=  1001     &&  nBestHeight <  5000    ){ nSubsidy =   3    * COIN; }
else if(nBestHeight >=  5001     &&  nBestHeight <  10000   ){ nSubsidy =   5    * COIN; }
else if(nBestHeight >=  10001    &&  nBestHeight <  13000   ){ nSubsidy =   10   * COIN; }
else if(nBestHeight >=  13001    &&  nBestHeight <  16000   ){ nSubsidy =   12   * COIN; }
else if(nBestHeight >=  16001    &&  nBestHeight <  19000   ){ nSubsidy =   13   * COIN; }
else if(nBestHeight >=  19001    &&  nBestHeight <  22000   ){ nSubsidy =   0.5  * COIN; }
else if(nBestHeight >=  22001    &&  nBestHeight <  25000   ){ nSubsidy =   0.7  * COIN; }
else if(nBestHeight >=  25001    &&  nBestHeight <  28000   ){ nSubsidy =   0.9  * COIN; }
else if(nBestHeight >=  28001    &&  nBestHeight <  31000   ){ nSubsidy =   1.1  * COIN; }
else if(nBestHeight >=  31001    &&  nBestHeight <  35000   ){ nSubsidy =   1.3  * COIN; }
else if(nBestHeight >=  35001    &&  nBestHeight <  45000   ){ nSubsidy =   1.5  * COIN; }
else if(nBestHeight >=  45001    &&  nBestHeight <  75000   ){ nSubsidy =   3    * COIN; }
else if(nBestHeight >=  75001    &&  nBestHeight <  100000  ){ nSubsidy =   5    * COIN; }
else if(nBestHeight >=  100001   &&  nBestHeight <  130000  ){ nSubsidy =   7    * COIN; }
else if(nBestHeight >=  130001   &&  nBestHeight <  160000  ){ nSubsidy =   10   * COIN; }
else if(nBestHeight >=  160001   &&  nBestHeight <  200000  ){ nSubsidy =   12   * COIN; }
else if(nBestHeight >=  200001   &&  nBestHeight <  300000  ){ nSubsidy =   15   * COIN; }
else if(nBestHeight >=  300001   &&  nBestHeight <  400000  ){ nSubsidy =   13   * COIN; }
else if(nBestHeight >=  400001   &&  nBestHeight <  500000  ){ nSubsidy =   10   * COIN; }
else if(nBestHeight >=  500001   &&  nBestHeight <  600000  ){ nSubsidy =   7    * COIN; }
else if(nBestHeight >=  600001   &&  nBestHeight <  3000000 ){ nSubsidy =   4    * COIN; }
        ...
        if(MasternodePayments)
        {
            ...
            if(IsProofOfStake() && pindex != NULL){
                if(pindex->GetBlockHash() == hashPrevBlock){
                    ...
                    CFdelAddress address2(address1);
